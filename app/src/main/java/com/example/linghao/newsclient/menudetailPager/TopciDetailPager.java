...
import com.example.linghao.newsclient.menudetailPager.tabledetailpager.ZhuantiDetailPager;
...
public class TopciDetailPager extends NewsDetailBasePager {
    private ArrayList<ZhuantiDetailPager> tableDetailPagers;//新闻中心各类页面的集合
    ...
    public TopciDetailPager(Context context, NewsPagerBean.DataBean dataBean) {
        super(context);
    ...
    public void initData() {
        ...
        for (int i = 0; i < children.size(); i++) {
            tableDetailPagers.add(new ZhuantiDetailPager(context, children.get(i)));
        }
        viewPager.setAdapter(new TopciDetailPager.MyNewsDetailPagerAdapter());
/**
 * 为中国，生活等子页面设置指示器
 */
        tabLayout.setupWithViewPager(viewPager);
        viewPager.addOnPageChangeListener(new TopciDetailPager.MyOnPageChangeListener());
    ...
    class MyNewsDetailPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ZhuantiDetailPager tableDetailPager = tableDetailPagers.get(position);
